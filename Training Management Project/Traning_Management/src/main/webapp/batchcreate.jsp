					...
					<div class="padding_20">
						...
						<div class="grid_6 alpha">
								...
								<div class="padding_20 text-justify">
									<form ng-submit="submit()" name="btcfrm">
								...
								<form id="frmMain"  class="frmMain" ng-submit="submitsearch()">
									<table class="form-table" style="width:auto">
											...
											<tr>
												...
												<td><input type="text" name="batch" ng-model="batch.batch_id" style="width:120%" value="">
										...
										<tr>
											...
											<td>
												...
												<tr>
													...
													<tr ng-repeat="b in bat.batches">
														
														<td><span ng-bind="b.batch_id"></span></td>
							                              <td><span ng-bind="b.batch_name"></span></td>
							                              <td><span ng-bind="b.batch_start_date"></span></td>
							                              <td><span ng-bind="b.batch_end_date"></span></td>
							                              <td>
							                              <button type="button" ng-click="bat.edit(b.batch_id)" >Edit</button>  
							                              <button type="button" ng-click="bat.remove(b.batch_id)">Remove</button>
							                              </td>
